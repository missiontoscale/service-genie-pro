...
const blogPosts = [
  {
    ...
    description: "Learn how to create professional invoices in minutes using AI technology.",
    date: "2024-01-15",
  ...
  },
  {
    ...
    description: "Maximize your efficiency with these essential quote management strategies.",
    date: "2024-01-10",
    author: "Michael Chen",
  ...
  },
  {
    ...
    description: "How AI is revolutionizing the way we create and manage business documents.",
    date: "2024-01-05",
    author: "Emily Davis",
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Tips, insights, and updates from the QuoteFlow AI team
              </p>
            </div>
