        ...
        <section className="py-24 bg-gradient-to-br from-background via-background to-primary/5">
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-left space-y-6">
              ...
              <p className="text-lg text-muted-foreground">
                Our platform combines the power of artificial intelligence with an intuitive interface, allowing you to create professional documents in minutes, not hours. Whether you're a freelance designer, consultant, or running a service-based business, QuoteFlow AI adapts to your workflow.
              </p>
              <p className="text-lg text-muted-foreground">
