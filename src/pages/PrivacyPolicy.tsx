          ...
          <div className="space-y-8 text-left">
            <section>
              ...
              <p className="text-muted-foreground">
                Quotla ("we", "our", or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our platform.
              </p>
            </section>
